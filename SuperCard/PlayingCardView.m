...
#define PIP_VOFFSET3_PERCENTAGE 0.300
#define PIP_VOFFSET4_PERCENTAGE 0.200

- (void)drawPips
{
    // Draw the single pips in the middle
    // Middle pip not mirrored used for 1, 3, 5, and 9
    if ((self.rank == 1) || (self.rank == 5) || (self.rank == 9) || (self.rank == 3)) {
        [self drawPipsWithHorizontalOffset:0 verticalOffset:0 mirroredVertically:NO];
    }
    // Top row pip used for 2 and 3
    ...
    // Next row pip used for 7 and 8, but not mirrored for 7
    ...
    // Next row pair used for 9 and 10
                          ...
                          upsideDown:(BOOL)upsideDown
{
    ...
    // horizontal offset then draw the second pip of the pair
    if (hoffset) {
